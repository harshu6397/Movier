...
const Series = ({ items, itemName, page, getTvShows, loading, searchTerm, setSearchTerm }) => {
    ...
    const handleClick = () => {
        setIsSearching(true);
        if (searchTerm !== '') {
            getTvShows(page, searchTerm.toLowerCase());
        }
    }
    ...
    return (
        <div className="flex justify-start flex-col items-center w-full">
            ...
            <div className="items-container w-full text-center">
                {

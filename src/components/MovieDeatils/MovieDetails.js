...
const MovieDetails = () => {
    ...
    const getDetails = async (videoId) => {
        const response = await axios.get(`https://api.themoviedb.org/3/movie/${videoId}?api_key=2beb22c118b4fce0394ce433a0c50f94&language=en-US`);
        setDeatils(response.data)
        console.log(response.data);
    }

    const getMovieCredits = async (videoId) => {
        const response = await axios.get(`https://api.themoviedb.org/3/movie/${videoId}/credits?api_key=2beb22c118b4fce0394ce433a0c50f94&language=en-US`);
        console.log(response.data);
        setCredits(response.data)
    }

    const getVideosAndImageUrl = async (videoId) => {
        const response = await axios.get(`https://api.themoviedb.org/3/movie/${videoId}/videos?api_key=2beb22c118b4fce0394ce433a0c50f94&language=en-US`)
    ...
    const getPhotos = async (videoId) => {
        const response = await axios.get(`https://api.themoviedb.org/3/movie/${videoId}/images?api_key=2beb22c118b4fce0394ce433a0c50f94`)
        setPhotos(response.data.backdrops)
    }

    const getRecommendedMovies = async (videoId) => {
        const response = await axios.get(`https://api.themoviedb.org/3/movie/${videoId}/recommendations?api_key=2beb22c118b4fce0394ce433a0c50f94&language=en-US&page=1`)
    ...
    return (
        <div className='deatils-conatiner'>
            ...
            {
                isPictures && <div className="pictures-container flex gap-2 flex-wrap w-[95%] m-auto mt-12 justify-center border-b-2 border-black border-opacity-20 pb-[2rem]">
                    {
                        photos?.map((photo) => {
                                    ...
                                    <div className="movie-item rounded-md">
                                        ...
                                        <div className="movie-item-content">
                                            ...
                                            <div className="movie-infos">
                                                ...
                                                <div className="movie-info">
                                                    <i className="bx bxs-time"></i>
                                                    <span>{item.release_date} mins</span>
                                                </div>
                                                <div className="movie-info">
                                                    <i className="bx bxs-comment-detail"></i>
